    ...
    return (
        <div className='shadow-sm border-b bg-white sticky top-0 z-50'>
            <div className='flex justify-between max-w-6xl mx-5 xl:mx-auto'>
                {/* Left */}
                <div className='relative w-24 hidden lg:inline-grid cursor-pointer' onClick={() => router.push("/")}>
                    ...
                    {session ? (
                        <>
                            <div className='relative navBtn'>
                                ...
                                <div className='absolute -top-1 -right-2 text-xs w-5 h-5 bg-red-500 rounded-full flex items-center justify-center animate-pulse'>3</div>
                            </div>
